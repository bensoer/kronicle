...
from kronicle.settings import Settings
from kronicle.health_check.health_status_thread import HealthStatusThread
...
logger = logging.getLogger("kronicle")
...
====================================
  Created By Ben Soer (@bensoer)    """
    ...
    # Initialise resources here. If this does not throw exceptions or fail then health checks can be marked as ready
