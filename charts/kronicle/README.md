...
This chart bootstraps a [Kronicle](https://github.com/bensoer/kronicl) deployment on a
...
The command deploys Kronicle on the Kubernetes cluster in the default configuration. The [configuration](#configuration) section lists the parameters that can be configured during installation.
